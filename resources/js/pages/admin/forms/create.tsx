...
interface AdminFormCreateProps {
    tenants: Tenant[];
}
...
export default function AdminFormCreate({ tenants }: AdminFormCreateProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.forms.store'), submitData as any);
    };

    return (
        <AppLayout>
            <Head title="Admin - Create Form" />
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Create a new form for any tenant</p>
                        </div>
                    </div>
