...
export default function PermissionCreate({ existingGroups }: PermissionCreateProps) {
    ...
    const handleNameChange = (name: string) => {
        setData(data => ({
            ...
            permission_key: data.permission_key || generatePermissionKey(name, data.permission_group)
        }));
    };
    ...
    const handleGroupChange = (group: string) => {
        setData(data => ({
            ...
            permission_key: data.permission_key || generatePermissionKey(data.name, group)
        }));
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Dodaj nowe uprawnienie" />
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Dodaj nowe uprawnienie</h1>
                            <p className="text-gray-600">Utwórz nowe uprawnienie systemu</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            ...
                            {processing ? 'Zapisywanie...' : 'Zapisz uprawnienie'}
                        </Button>
                    </div>
                </form>
            </div>
