...
const CreateJob: React.FC<Props> = ({ locations, sectors }) => {
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <h1 className="text-3xl font-bold text-gray-900">Nowa praca</h1>
                        </div>
                        <p className="text-gray-600">
                            Utwórz nowe zlecenie pracy dla swojej organizacji
                        </p>
                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-end gap-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Tworzenie...' : 'Utwórz pracę'}
                                </Button>
                            </div>
                        </div>
                    </form>
