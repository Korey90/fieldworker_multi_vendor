...
import { ChevronDown, Plus, Search, Filter, Bell, AlertTriangle, Info, CheckCircle, AlertCircle, Settings, Trash2, Eye, Grid3X3, List, Edit, Check, User, Clock } from 'lucide-react';
...
import * as tenantNotifications from '@/routes/tenant/notifications';
...
export default function TenantNotificationIndex({ notificationData, stats, filters }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Tenant Admin', href: '/tenant/dashboard' },
        { title: 'Notifications', href: tenantNotifications.index().url }
    ];
    ...
    const handleSelectAll = (checked: boolean) => {
        if (checked) {
            setSelectedNotifications(currentNotifications.map((n: Notification) => n.id));
        } else {
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        router.get(tenantNotifications.index().url, { ...safeFilters, search: searchTerm }, { 
            preserveState: true,
            replace: true 
        });
    };
    ...
    const handleFilterChange = (key: string, value: any) => {
        ...
        router.get(tenantNotifications.index().url, newFilters, { 
            preserveState: true,
            replace: true 
        });
    };
    ...
    const handleMarkAsRead = (notificationId: number) => {
        router.post(tenantNotifications.markAsRead(notificationId.toString()).url);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Organization Notifications" />
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Manage notifications for your organization
                            </p>
                        </div>
                        <Link href={tenantNotifications.create().url}>
                            <Button>
                ...
                <Card>
                        ...
                        {showFilters && (
                            <div className="grid gap-4 pt-4 border-t md:grid-cols-3">
                                ...
                                <div className="flex items-end">
                                    <Button
                                        variant="outline"
                                        onClick={() => router.get(tenantNotifications.index().url)}
                                        className="w-full"
                                    >
                                        Clear Filters
                                    </Button>
                    ...
                    <CardContent>
                        {currentNotifications.length === 0 ? (
                            ...
                            /* Simplified Table View for Tenant Admin */
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableRow key={notification.id}>
                                            ...
                                            <TableCell>
                                                {notification.user ? (
                                                    ...
                                                    <span className="text-gray-400">All Team</span>
                                                )}
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => router.get(tenantNotifications.show(notification.id.toString()).url)}
                                                    >
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => router.delete(tenantNotifications.destroy(notification.id.toString()).url)}
                                                    >
                            ...
                            <div className="flex items-center justify-between space-x-2 py-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.get(tenantNotifications.index().url, { ...safeFilters, page: meta.current_page - 1 })}
