...
const activityColors = {
  ...
  job_pending: 'text-gray-600',
  job_assigned: 'text-purple-600',
  job_cancelled: 'text-red-600',
        ...
        <div className="h-[400px] overflow-y-auto">
          <div className="space-y-4">
            {displayedActivities.map((activity) => {
              ...
              const iconColor = activityColors[activity.type] || 'text-gray-600'; // Fallback color
              return (
